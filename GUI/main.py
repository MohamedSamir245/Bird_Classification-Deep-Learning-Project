...
IMAGE_PATH = "GUI\Dependencies\OIP.jpg"
LABELS_DICT = {}
MODEL_DETAILS = {}
...
def init():
    ...
    with open("GUI\Dependencies\labels.json", 'r') as f:
        LABELS_DICT = json.load(f)

    with open("GUI\Dependencies\modelDetails.json", 'r') as f:
        MODEL_DETAILS = json.load(f)

    model = tf.keras.models.load_model(
        "GUI\Dependencies\InceptionV3_finetuned_input224_earlystopping.h5")
    return model
